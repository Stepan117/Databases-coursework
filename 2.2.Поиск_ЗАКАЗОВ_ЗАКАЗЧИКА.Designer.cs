namespace Степан
{
    partial class Поиск_ЗАКАЗОВ_ЗАКАЗЧИКА
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Поиск_ЗАКАЗОВ_ЗАКАЗЧИКА));
            ...
            this.Name = "Поиск_ЗАКАЗОВ_ЗАКАЗЧИКА";
            this.Text = "Поиск_ЗАКАЗОВ_ЗАКАЗЧИКА";
            this.Load += new System.EventHandler(this.Поиск_ЗАКАЗОВ_ЗАКАЗЧИКА_Load);
