...
namespace Степан
{
    public partial class Редактирование_данных_СОТРУДНИКА : Form
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("INSERT INTO Сотрудник(ID_Сотрудник, ФИО, Телефон)values('" + textBox1.Text + "', '" + textBox2.Text + "', '" + textBox3.Text + "')", con1);
            cmd.ExecuteNonQuery();
            Load_Data();
            clear_fun();
        ...
        {
            SqlCommand cmd = new SqlCommand("UPDATE Сотрудник SET ФИО='" + textBox2.Text + "', Телефон='" + textBox3.Text + "' where ID_Сотрудник='" + textBox1.Text + "'", con1);
            cmd.ExecuteNonQuery();
            Load_Data();
            clear_fun();
        ...
        {
            SqlCommand del_cmd = new SqlCommand("DELETE FROM Сотрудник WHERE ID_Сотрудник='" + textBox1.Text + "'", con1);
        ...
        private void Редактирование_данных_СОТРУДНИКА_Load(object sender, EventArgs e)
        {
            con1.Open();
            Load_Data();
        }
